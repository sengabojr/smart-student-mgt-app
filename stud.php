...
<body class="bg-gray-100 flex min-h-screen">
    ...
    <div class="main flex-grow ml-64 p-8">
        <div class="nav mb-8">
            <h1 class="text-3xl font-extrabold text-gray-800 border-b-2 border-blue-500 pb-1 inline-block">Student's List</h1>
        </div>
        
        <div class="php mt-6">
            <table class="min-w-full table-auto shadow-xl bg-white rounded-lg overflow-hidden border-separate border-spacing-0">
                <thead>
                    <tr>
                        ...
                        <th class="py-3 px-4 bg-gray-700 text-left text-xs font-semibold text-white uppercase tracking-wider w-[25%]">Name</th>
                        <th class="py-3 px-4 bg-gray-700 text-left text-xs font-semibold text-white uppercase tracking-wider w-[35%]">Email</th>
